const movies = document.querySelector(".flowers")
const movies_block = document.querySelector(".flowers-block")
...
async function renderHTml() {
    ...
    products.forEach(function (element, index) {
        flowers_block_block.innerHTML += `
        <a href="productdetails.html?id=${element.id}"><img src ="${element.image}"alt ="flowers"></a>
