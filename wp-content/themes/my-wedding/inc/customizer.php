...
function my_wedding_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('my_wedding_site_title_fontsize',array(
		'default' => '',
		'sanitize_callback'	=> 'my_wedding_sanitize_float'
	));
	$wp_customize->add_control('my_wedding_site_title_fontsize',array(
		'type' => 'number',
		'label' => __('Site Title Font Size','my-wedding'),
		'section' => 'title_tagline',
	));
	...
	$wp_customize->add_setting('my_wedding_site_tagline_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'my_wedding_sanitize_float'
	));
	$wp_customize->add_control('my_wedding_site_tagline_font_size',array(
		'type' => 'number',
		'label' => __('Site Tagline Font Size','my-wedding'),
		'section' => 'title_tagline',
	));
	...
	$wp_customize->add_setting( 'my_wedding_slider_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	   ));
	 $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'my_wedding_slider_color', array(
		   'label' => 'Text Color',
		'section' => 'my_wedding_slider_section',
	   )));
	...
	$wp_customize->add_section('my_wedding_about_section',array(
		...
		'description'=> __('<b>Note</b> : This section will appear below the slider.','my-wedding'),
		'panel' => 'my_wedding_panel_id',
	));
	...
	$wp_customize->add_setting( 'my_wedding_about_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	   ));
	 $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'my_wedding_about_color', array(
		   'label' => 'Text Color',
		'section' => 'my_wedding_about_section',
	   )));
    ...
    $wp_customize->add_section( 'my_wedding_footer', array(
    	'title'  => __( 'Footer Setting', 'my-wedding' ),
		'priority' => null,
		'panel' => 'my_wedding_panel_id'
	) );
	...
	$wp_customize->add_control('my_wedding_footer_copy',array(
		'label'	=> __('Copyright Text','my-wedding'),
		'section' => 'my_wedding_footer',
		'setting' => 'my_wedding_footer_copy',
		'type' => 'text'
	));

	$wp_customize->add_setting('my_wedding_copyright_padding',array(
		'default' => '',
		'sanitize_callback'	=> 'my_wedding_sanitize_float'
 	));
 	$wp_customize->add_control('my_wedding_copyright_padding',array(
		'type' => 'number',
		'label' => __('Copyright Top Bottom Padding','my-wedding'),
		'section' => 'my_wedding_footer',
	));
